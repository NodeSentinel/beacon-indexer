...
CREATE TABLE "public"."validators_snapshot_stats" (
    ...
    "attestation_count_h" INTEGER NOT NULL DEFAULT 0,
    "missed_attestation_count_h" INTEGER NOT NULL DEFAULT 0,
    "attestation_count_d" INTEGER NOT NULL DEFAULT 0,
    "missed_attestation_count_d" INTEGER NOT NULL DEFAULT 0,
    "attestation_count_w" INTEGER NOT NULL DEFAULT 0,
    "missed_attestation_count_w" INTEGER NOT NULL DEFAULT 0,
    "attestation_count_m" INTEGER NOT NULL DEFAULT 0,
    "missed_attestation_count_m" INTEGER NOT NULL DEFAULT 0,
